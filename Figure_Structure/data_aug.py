...
def main():
    source_tokens = "cpg_graph/data_tokens.pkl"
    source_labels = "cpg_graph/data_labels.pkl"
    source_location = "cpg_graph/data_location.pkl"
    target_tokens = "java_cpg_graph/data_tokens.pkl"
    target_labels = "java_cpg_graph/data_labels.pkl"
    target_location = "java_cpg_graph/data_location.pkl"

    ssave_tokens_path = "dann_data_aug/s2/data_tokens.pkl"
    ssave_labels_path = "dann_data_aug/s2/data_labels.pkl"
    ssave_location_path = "dann_data_aug/s2/data_location.pkl"
    ssave_tokens_path_txt = "dann_data_aug/s2/data_tokens.txt"
    ssave_labels_path_txt = "dann_data_aug/s2/data_labels.txt"
    ssave_location_path_txt = "dann_data_aug/s2/data_location.txt"

    tsave_tokens_path = "dann_data_aug/t2/data_tokens.pkl"
    tsave_labels_path = "dann_data_aug/t2/data_labels.pkl"
    tsave_location_path = "dann_data_aug/t2/data_location.pkl"
    tsave_tokens_path_txt = "dann_data_aug/t2/data_tokens.txt"
    tsave_labels_path_txt = "dann_data_aug/t2/data_labels.txt"
    tsave_location_path_txt = "dann_data_aug/t2/data_location.txt"
