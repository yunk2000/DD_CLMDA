...
def main():
    train_data_path = 'java_merge_data/java_ast_data.txt'
    save_tokens_path = "java_ast_train/ast_data_tokens.pkl"
    save_labels_path = "java_ast_train/ast_data_labels.pkl"
    save_location_path = "java_ast_train/ast_data_location.pkl"
    
    save_tokens_path_txt = "java_ast_train/ast_data_tokens.txt"
    save_labels_path_txt = "java_ast_train/ast_data_labels.txt"
    save_location_path_txt = "java_ast_train/ast_data_location.txt"

    if os.path.exists("java_ast_train"):
        shutil.rmtree("java_ast_train")
    os.mkdir("java_ast_train")
