...
def main():
    tokens_path = "ast_train/ast_data_tokens.pkl"
    labels_path = "ast_train/ast_data_labels.pkl"
    location_path = "ast_train/ast_data_location.pkl"
    out_put_features = 'token_features_train/'
