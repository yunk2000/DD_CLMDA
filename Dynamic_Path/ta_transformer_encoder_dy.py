...
def main():
    tokens_path = "java_dy_train/dy_data_tokens.pkl"
    labels_path = "java_dy_train/dy_data_labels.pkl"
    location_path = "java_dy_train/dy_data_location.pkl"
    out_put_features = 'java_token_features_train_dy/'
    save_dir = './java_model'
