...
def main():
    ...
    ast_sen_data = './java_dy_info/'
    vul_line = '/home/zzb/next_model/datasets/target_vul.xml'
    merge_data = 'java_merge_data/dy_data.txt'

    if os.path.exists("java_merge_data"):
        shutil.rmtree("java_merge_data")
    os.mkdir("java_merge_data")
