...
def main():
    source_tokens = "dy_train/dy_data_tokens.pkl"
    source_labels = "dy_train/dy_data_labels.pkl"
    source_location = "dy_train/dy_data_location.pkl"
    target_tokens = "java_dy_train/dy_data_tokens.pkl"
    target_labels = "java_dy_train/dy_data_labels.pkl"
    target_location = "java_dy_train/dy_data_location.pkl"

    ssave_tokens_path = "dann_data_aug/s2/dy_data_tokens.pkl"
    ssave_labels_path = "dann_data_aug/s2/dy_data_labels.pkl"
    ssave_location_path = "dann_data_aug/s2/dy_data_location.pkl"
    ssave_tokens_path_txt = "dann_data_aug/s2/dy_data_tokens.txt"
    ssave_labels_path_txt = "dann_data_aug/s2/dy_data_labels.txt"
    ssave_location_path_txt = "dann_data_aug/s2/dy_data_location.txt"

    tsave_tokens_path = "dann_data_aug/t2/dy_data_tokens.pkl"
    tsave_labels_path = "dann_data_aug/t2/dy_data_labels.pkl"
    tsave_location_path = "dann_data_aug/t2/dy_data_location.pkl"
    tsave_tokens_path_txt = "dann_data_aug/t2/dy_data_tokens.txt"
    tsave_labels_path_txt = "dann_data_aug/t2/dy_data_labels.txt"
    tsave_location_path_txt = "dann_data_aug/t2/dy_data_location.txt"
