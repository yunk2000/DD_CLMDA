...
def open_data_txt(filename):
    with open(filename, 'r') as file:
        ...
        for segment in segments:
            ...
            words = line[0].split(" ")  # get location
...
def main():
    train_data_path = 'java_merge_data/dy_data.txt'
    save_tokens_path = "java_dy_train/dy_data_tokens.pkl"
    save_labels_path = "java_dy_train/dy_data_labels.pkl"
    save_location_path = "java_dy_train/dy_data_location.pkl"

    save_tokens_path_txt = "java_dy_train/dy_data_tokens.txt"
    save_labels_path_txt = "java_dy_train/dy_data_labels.txt"
    save_location_path_txt = "java_dy_train/dy_data_location.txt"

    if os.path.exists("java_dy_train"):
        shutil.rmtree("java_dy_train")
    os.mkdir("java_dy_train")
